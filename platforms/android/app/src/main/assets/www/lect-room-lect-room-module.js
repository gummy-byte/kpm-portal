(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["lect-room-lect-room-module"],{
...
/***/ "./src/app/lect-room/lect-room.module.ts":
/*!***********************************************!*\
  !*** ./src/app/lect-room/lect-room.module.ts ***!
  \***********************************************/
/*! exports provided: LectRoomPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LectRoomPageModule", function() { return LectRoomPageModule; });
...
/* harmony import */ var _lect_room_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lect-room.page */ "./src/app/lect-room/lect-room.page.ts");
...
var routes = [
    {
        path: '',
        component: _lect_room_page__WEBPACK_IMPORTED_MODULE_6__["LectRoomPage"]
    }
];
var LectRoomPageModule = /** @class */ (function () {
    function LectRoomPageModule() {
    }
    LectRoomPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_lect_room_page__WEBPACK_IMPORTED_MODULE_6__["LectRoomPage"]]
        })
    ], LectRoomPageModule);
    return LectRoomPageModule;
}());
...
/***/ "./src/app/lect-room/lect-room.page.html":
/*!***********************************************!*\
  !*** ./src/app/lect-room/lect-room.page.html ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\r\n  <ion-toolbar color=\"primary\">\r\n\t<ion-back-button slot=\"start\" color=\"light\" text=\"\"></ion-back-button>\r\n    <ion-title text-center>Senarai Pensyarah</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content fullscreen class=\"ion-padding\">\r\n\t<ion-searchbar (ionChange)=\"onSearchTerm($event)\" placeholder=\"Carian\" showCancelButton=\"focus\"></ion-searchbar>\r\n\t<ion-item *ngFor=\"let row of lecturer;\">\r\n\t\t<ion-label>\r\n\t\t\t<div class=\"lect-name-room\">\r\n\t\t\t\t<ion-note class=\"capitalize\" color=\"medium\"><small><b><ion-icon class=\"va-text-top\"name=\"home\"></ion-icon>{{toTitleCase(row.room)}}</b></small></ion-note><br>\r\n\t\t    <p class=\"word-break capitalize\">{{toTitleCase(row.name)}}</p>\r\n\t  \t</div>\r\n\t\t\t<ion-chip *ngIf=\"row.course.includes('SAINS KUANTITATIF')\" class=\"department-chip capitalize\" color=\"danger\">{{toTitleCase(row.course)}}</ion-chip>\r\n\t\t\t<ion-chip *ngIf=\"row.course.includes('PENGAJIAN AM')\" class=\"department-chip capitalize\" color=\"secondary\">{{toTitleCase(row.course)}}</ion-chip>\r\n\t\t\t<ion-chip *ngIf=\"row.course.includes('PENGAJIAN PERNIAGAAN')\" class=\"department-chip capitalize\" color=\"tertiary\">{{toTitleCase(row.course)}}</ion-chip>\r\n\t\t\t<ion-chip *ngIf=\"row.course.includes('PERAKAUNAN')\" class=\"department-chip capitalize\" color=\"success\">{{toTitleCase(row.course)}}</ion-chip>\r\n\t\t\t<ion-chip *ngIf=\"row.course.includes('JABATAN LANDSCAPE')\" class=\"department-chip capitalize\" color=\"warning\">{{toTitleCase(row.course)}}</ion-chip>\r\n\t\t</ion-label>\r\n\t</ion-item>\r\n\t<!-- <p ngIf=\"lecturer.length <= 0\">No Result Found</p> -->\r\n</ion-content>"

/***/ }),

/***/ "./src/app/lect-room/lect-room.page.scss":
/*!***********************************************!*\
  !*** ./src/app/lect-room/lect-room.page.scss ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = ".department-chip {\n  padding: 0px 10px;\n  font-size: 0.65rem;\n  height: 1.3rem; }\n\n.lect-name-room {\n  margin-left: 14px; }\n\n.va-text-top {\n  vertical-align: text-top; }\n\n.word-break {\n  white-space: normal;\n  overflow-wrap: break-word; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/lect-room/lect-room.page.ts":
/*!*********************************************!*\
  !*** ./src/app/lect-room/lect-room.page.ts ***!
  \*********************************************/
/*! exports provided: LectRoomPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LectRoomPage", function() { return LectRoomPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var LectRoomPage = /** @class */ (function () {
    function LectRoomPage(http) {
        this.http = http;
        this.csvData = [];
        this.lecturer = [];
        this.allLecturer = [];
    }
    LectRoomPage.prototype.readCsvData = function () {
        var _this = this;
    ...
    LectRoomPage.prototype.extractData = function (res) {
        var csvData = res['_body'] || '';
        var parsedData = papaparse__WEBPACK_IMPORTED_MODULE_3__["parse"](csvData, { header: false }).data;
    ...
    LectRoomPage.prototype.onSearchTerm = function (ev) {
        this.lecturer = this.allLecturer;
        var val = ev.detail.value;
        if (val.trim() !== '') {
            this.lecturer = this.lecturer.filter(function (term) {
                return term.name.toLowerCase().indexOf(val.trim().toLowerCase()) > -1;
            });
        }
    };
    LectRoomPage.prototype.handleError = function (err) {
        console.log('something went wrong: ', err);
    };
    LectRoomPage.prototype.toTitleCase = function (str) {
        return str.replace(/\w\S*/g, function (txt) {
            return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();
        });
    };
    LectRoomPage.prototype.ngOnInit = function () {
        this.readCsvData();
    };
    LectRoomPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-lect-room',
            template: __webpack_require__(/*! ./lect-room.page.html */ "./src/app/lect-room/lect-room.page.html"),
            styles: [__webpack_require__(/*! ./lect-room.page.scss */ "./src/app/lect-room/lect-room.page.scss")]
        }),
...
//# sourceMappingURL=lect-room-lect-room-module.js.map